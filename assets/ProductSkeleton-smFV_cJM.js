import{W as G,X as O,_ as h,q as C,p as y,Y as W,Z as K,$ as q,r as f,m as I,n as P,j as r,o as _,a0 as Y,t as M,g as U,a1 as j,s as T,k as V,h as Z,a2 as F,w as z,a3 as S,b as H,L as J,a4 as Q}from"./index-Y5mTZmp0.js";const ee=G(),te=["component","direction","spacing","divider","children","className","useFlexGap"],se=O(),ae=ee("div",{name:"MuiStack",slot:"Root",overridesResolver:(e,t)=>t.root});function oe(e){return Y({props:e,name:"MuiStack",defaultTheme:se})}function ne(e,t){const s=f.Children.toArray(e).filter(Boolean);return s.reduce((a,i,o)=>(a.push(i),o<s.length-1&&a.push(f.cloneElement(t,{key:`separator-${o}`})),a),[])}const re=e=>({row:"Left","row-reverse":"Right",column:"Top","column-reverse":"Bottom"})[e],ie=({ownerState:e,theme:t})=>{let s=h({display:"flex",flexDirection:"column"},C({theme:t},y({values:e.direction,breakpoints:t.breakpoints.values}),a=>({flexDirection:a})));if(e.spacing){const a=W(t),i=Object.keys(t.breakpoints.values).reduce((n,c)=>((typeof e.spacing=="object"&&e.spacing[c]!=null||typeof e.direction=="object"&&e.direction[c]!=null)&&(n[c]=!0),n),{}),o=y({values:e.direction,base:i}),l=y({values:e.spacing,base:i});typeof o=="object"&&Object.keys(o).forEach((n,c,m)=>{if(!o[n]){const p=c>0?o[m[c-1]]:"column";o[n]=p}}),s=K(s,C({theme:t},l,(n,c)=>e.useFlexGap?{gap:j(a,n)}:{"& > :not(style):not(style)":{margin:0},"& > :not(style) ~ :not(style)":{[`margin${re(c?o[c]:e.direction)}`]:j(a,n)}}))}return s=q(t.breakpoints,s),s};function ce(e={}){const{createStyledComponent:t=ae,useThemeProps:s=oe,componentName:a="MuiStack"}=e,i=()=>M({root:["root"]},n=>U(a,n),{}),o=t(ie);return f.forwardRef(function(n,c){const m=s(n),u=I(m),{component:p="div",direction:k="column",spacing:B=0,divider:x,children:b,className:A,useFlexGap:D=!1}=u,L=P(u,te),X={direction:k,spacing:B,useFlexGap:D},E=i();return r.jsx(o,h({as:p,ownerState:X,ref:c,className:_(E.root,A)},L,{children:x?ne(b,x):b}))})}function le(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||""}function de(e){return parseFloat(e)}const ue=ce({createStyledComponent:T("div",{name:"MuiStack",slot:"Root",overridesResolver:(e,t)=>t.root}),useThemeProps:e=>V({props:e,name:"MuiStack"})}),pe=ue;function he(e){return U("MuiSkeleton",e)}Z("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const me=["animation","className","component","height","style","variant","width"];let v=e=>e,R,$,w,N;const ge=e=>{const{classes:t,variant:s,animation:a,hasChildren:i,width:o,height:l}=e;return M({root:["root",s,a,i&&"withChildren",i&&!o&&"fitContent",i&&!l&&"heightAuto"]},he,t)},fe=F(R||(R=v`
  0% {
    opacity: 1;
  }
